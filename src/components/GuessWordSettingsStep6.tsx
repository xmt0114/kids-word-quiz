...
export const GuessWordSettingsStep6: React.FC = () => {
    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-yellow-50 p-sm md:p-lg">
      ...
      <div className="max-w-4xl mx-auto space-y-xl">
        ...
        <section style={{ textAlign: 'center', marginTop: '30px' }}>
          <Button
            onClick={() => {
              console.log('Step 6 测试结果:', {
                allFeaturesLoaded: true,
                customTailwindClasses: '使用中...',
                settings: selectedSettings,
                textbookInfo
              });
              alert('Step 6 测试完成！所有自定义 Tailwind 类名已应用。');
            }}
            variant="primary"
            size="default"
          >
